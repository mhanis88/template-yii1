...
$('.search-form form').submit(function(){
	$('#sys-controller-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h3><?php echo Yii::t('app', 'Controller') ?></h3>
...
if (GeneralFunction::roleCheckerAction(Yii::app()->user->role, Yii::app()->controller, "create") ||
    ...
    $header = '';
    if (GeneralFunction::roleCheckerAction(Yii::app()->user->role, Yii::app()->controller, 'create')):
        $header .= CHtml::link('<span class="glyphicon glyphicon-plus"></span>', Yii::app()->createUrl('config/sysController/create'), array('class' => 'btn btn-info btn-sm', 'id' => 'add-record', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => Yii::t('app', 'Add')));
    endif;
    ...
    if (GeneralFunction::roleCheckerAction(Yii::app()->user->role, Yii::app()->controller, 'deleteBulk')):
        ...
        $url = Yii::app()->createUrl('config/sysController/deleteBulk');
        $ajaxOptions = [
            'type' => 'POST',
            ...
            'success' => "function(data){
                    ...
                    $.fn.yiiGridView.update('sys-controller-grid');
                    $.fn.ajaxBusy('stop', '');
                }"
        ];
    ...
    $columns[] = [
        ...
        'buttons' => [
            'my_edit' => [
                ...
                'url' => 'Yii::app()->createUrl( "config/sysController/update", ["id" => $data->controller_id ] )',
